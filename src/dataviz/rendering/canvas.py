        ...
        *,
        ...
        if dashboard_control_keys or actionable:
            ...
            control_block = (
                ...
                '<summary class="dv-shell-control__trigger" aria-keyshortcuts="W Meta+Control+W">'
        ...
        if card_is_present:
            query_control = (
                ...
                'aria-expanded="false" aria-keyshortcuts="E Meta+Control+E" title="Open parameters" '
        ...
        return (
            ...
            '<div><dt><kbd data-shortcut-key="W">W</kbd></dt><dd>Controls</dd></div>'
            '<div><dt><kbd data-shortcut-key="E">E</kbd></dt><dd>Parameters</dd></div>'
